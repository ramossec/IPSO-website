        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <a
                ...
                className="rounded-md bg-white/10 p-3 text-white transition-colors hover:bg-ipso-teal"
              >
            ...
            <ul className="space-y-1">
              {servicesLinks.map((l) => (
                <li key={l.label}>
                  <Link
                    to={l.to}
                    className="inline-block py-1 text-sm text-white/75 transition-colors hover:text-ipso-teal-light"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm text-white/75">
              ...
              <li>
                <a href={`mailto:${siteConfig.email}`} className="inline-block py-1 transition-colors hover:text-ipso-teal-light">
                  {siteConfig.email}
                </a>
              </li>
              <li>
                <a href={siteConfig.phoneHref} className="inline-block py-1 transition-colors hover:text-ipso-teal-light">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block py-1 transition-colors hover:text-ipso-teal-light"
                >
